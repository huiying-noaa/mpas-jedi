...
subroutine mpas_increment_update_fields_c(c_key_self, c_key_geom, c_vars) &
  bind(c,name='mpas_increment_update_fields_f90')
...
end subroutine mpas_increment_update_fields_c
